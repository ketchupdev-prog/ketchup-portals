...
/**
 * Ketchup Profile – Account view for Ketchup operations staff.
...
const ROLE_LABELS: Record<string, string> = {
  ketchup_ops: 'Ketchup operations',
...
export default function KetchupProfilePage() {
  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <SectionHeader title="Profile" description="Your Ketchup portal account and settings." />
  ...
  return (
    <PortalProfileView
      title="Profile"
      description="Your Ketchup portal account and settings."
      roleLabel={me ? (ROLE_LABELS[me.role] ?? me.role) : 'Ketchup operations'}
      name={me?.full_name}
      email={me?.email}
      settingsHref="/ketchup/settings"
    />
  );
}
