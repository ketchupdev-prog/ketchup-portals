...
const LEGACY_ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  gov_manager: ["dashboard.summary", "programmes.list", "government.reports", "audit.view", "reports.generate"],
  gov_auditor: ["programmes.list", "government.reports", "audit.view", "reports.generate"],
  ...
  field_lead: ["field.tasks", "field.map", "field.assets", "field.tasks.assign", "assets.manage", "incidents.manage"],
};
